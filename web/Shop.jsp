...
<c:forEach items="${listP}" var="o">
  ...
  <script>
    ...
    function load(cateid){
    	 $.ajax({
             url: "/WebQuanLyBanGiay/categoryShop",
    ...
    function searchByName(param){
        ...
        $.ajax({
            url: "/WebQuanLyBanGiay/searchAjaxShop",
            type: "get", //send it through get method
            data: {
                txt: txtSearch
            },
    ...
    function searchByPriceMinToMax(){
        ...
        $.ajax({
            url: "/WebQuanLyBanGiay/searchAjaxPriceMinToMax",
            type: "get", //send it through get method
            data: {
                priceMin: numMin,
                priceMax: numMax
    ...
    function searchByPriceUnder100(){
        $.ajax({
            url: "/WebQuanLyBanGiay/searchAjaxPriceUnder100Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPrice100To200(){
        $.ajax({
            url: "/WebQuanLyBanGiay/searchAjaxPrice100To200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPriceAbove200(){
        $.ajax({
            url: "/WebQuanLyBanGiay/searchAjaxPriceAbove200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorWhite(){
        $.ajax({
            url: "/WebQuanLyBanGiay/searchAjaxColorWhite",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorGray(){
        $.ajax({
            url: "/WebQuanLyBanGiay/searchAjaxColorGray",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorBlack(){
        $.ajax({
            url: "/WebQuanLyBanGiay/searchAjaxColorBlack",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorYellow(){
        $.ajax({
            url: "/WebQuanLyBanGiay/searchAjaxColorYellow",
            type: "get", //send it through get method
            data: {
