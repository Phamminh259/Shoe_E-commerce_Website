		...
		try {
			...
			String deliveryAddress = request.getParameter("deliveryAddress");
			 ...
			 HttpSession session = request.getSession();
				...
				email.setSubject("Dat hàng thành công tu Shop Giày PM");
				StringBuilder sb = new StringBuilder();
				sb.append("Dear ").append(name).append("<br>");
				sb.append("Bạn vừa đặt hàng thành công từ Shop Giày PM. <br> ");
				...
				sb.append("Các sản phẩm bạn đặt bao gồm: <br>");
				for(Cart c : list) {
					for(Product p : list2) {
						if(c.getProductID()==p.getId()) {
				...
				sb.append("Cảm ơn bạn đã đặt hàng tại Shop Giày PM<br>");
				sb.append("Chúc Bạn 1 ngày tốt lành^^");
