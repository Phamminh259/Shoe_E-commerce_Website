...
<nav class="navbar navbar-expand-md navbar-dark bg-dark" style="position: fixed; top: 0; width:100%;  z-index: 100000;">
    <div class="container">
        <a class="navbar-brand" href="home">Shop Giày PM</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            ...
            <li class="nav-item">
                        <a class="nav-link" href="home">Trang Chu</a>
                    </li> 
            <li class="nav-item">
                        <a class="nav-link" href="shop">Cua Hang</a>
                    </li> 
                ...
                <c:if test="${sessionScope.acc == null}">
                    <li class="nav-item">
                        <a class="nav-link" href="forgotPassword">Quen Mat Khau</a>
                    </li>
                </c:if>
                <c:if test="${sessionScope.acc != null}">
                    <li class="nav-item">
                        <a class="nav-link" href="EditProfile.jsp">Chinh Sua Trang Ca Nhan</a>
                    </li>
                </c:if>
